...
export function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden gradient-mesh">
      {/* Floating particles */}
        ...
        >
          ...
          {error && (
            <motion.div
              ...
              className="mb-4 p-3 rounded-xl text-sm bg-danger/10 text-danger border border-danger/20"
            >
              {error}
            </motion.div>
          )}
